...
export default function DashboardSkeleton({ theme }: DashboardSkeletonProps) {
  ...
  return (
    <div className="space-y-8 animate-pulse w-full max-w-full px-1">
      ...
      <div
        className={`relative rounded-lg p-4 sm:p-8 overflow-hidden onboarding-welcome ${
          ...
          <div className="h-9 sm:h-10 w-64 sm:w-72 mb-2 sm:mb-4 rounded animate-pulse bg-gray-300/30"></div>        
