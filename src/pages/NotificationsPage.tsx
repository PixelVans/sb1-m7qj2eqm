...
export default function NotificationsPage() {
  ...
  const formatTime = (timestamp: string) =>
    ...
    return (
      <div className="px-2 sm:px-4 py-4 sm:py-6 mb-9 flex flex-col items-center">
            ...
            <>
              <div className="space-y-4">
                {visibleNotifications.map((n) => (
                  <div
                    key={n.id}
                    className={`rounded-xl bg-[#121212] border p-4 flex shadow-slate-200 flex-col sm:flex-row sm:items-start sm:justify-between gap-4 shadow-md backdrop-blur-lg transition-opacity ${
                      typeColors[n.type]
                  ...
                  >
                    ...
                    <div className="flex items-end justify-between sm:flex-col sm:items-end gap-2">
                      ...
                      {n.read ? (
                        <span className="text-sm  text-green-300 mr-1">Read</span>
                      ) : (
                        <Button
                          size="sm"
                          variant="outline"
                        ...
                        >
                          <span className='text-sm text-yellow-200'>Mark as read</span>
                        </Button>
                      )}
                    </div>
                  </div>
