...
export default function DJDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Welcome */}
      <div
        className={`relative rounded-lg p-5 sm:p-8 overflow-hidden onboarding-welcome ${
          theme === 'dark'
      ...
      {shouldShowTutorial &&  (
  <div className="bg-white/5 rounded-lg p-4 sm:p-6 onboarding-create-event">
    ...
    <div className="p-4 rounded-lg bg-white/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          ...
          className={`rounded-lg p-4 sm:p-6 flex justify-between items-center  cursor-pointer onboarding-create-event ${
        ...
        <div
          ...
          className={`rounded-lg p-4 sm:p-6 flex justify-between  items-center cursor-pointer onboarding-requests ${
            theme === 'dark' ? 'bg-white/5 shadow-black shadow-md' : 'bg-white shadow-lg'
          } hover:bg-white/10 transition`}
        >
          <div>
